...
public class WonderInstances {
    ...
    public WonderInstances()
    {
        ...
        this.allWonders.add(new Wonder("Temple of Artemis", CAPITAL_CITY, ANCIENT_WORLD, new HashSet<>(Arrays.asList(TEMPLE)), STATUE, MILITARY, ECONOMY, MILITARY));
        this.allWonders.add(new Wonder("Stonehenge", CAPITAL_CITY, ANCIENT_WORLD, new HashSet<>(Arrays.asList(TEMPLE, STATUE)), TEMPLE, ECONOMY, RESEARCH, RESEARCH));
        this.allWonders.add(new Wonder("Hanging Gardens", CAPITAL_CITY, ANCIENT_WORLD, new HashSet<>(Arrays.asList(NATURE, PALACE)), PALACE, ECONOMY, ECONOMY, ECONOMY));
        this.allWonders.add(new Wonder("Statue of Zeus", CAPITAL_CITY, ANCIENT_WORLD, new HashSet<>(Arrays.asList(STATUE)), STATUE, MILITARY, NONE, MILITARY));
        this.allWonders.add(new Wonder("Cheops Pyramid", ALLIED_CULTURES, ANCIENT_WORLD, new HashSet<>(Arrays.asList(TEMPLE)), TEMPLE, ECONOMY, ECONOMY, ECONOMY));
        this.allWonders.add(new Wonder("Great Sphinx", ALLIED_CULTURES, ANCIENT_WORLD, new HashSet<>(Arrays.asList(STATUE)), STATUE, MILITARY, ECONOMY, MILITARY));
        ...
        this.allWonders.add(new Wonder("Terracotta Army", ALLIED_CULTURES, GREAT_EMPIRES, new HashSet<>(Arrays.asList(FORTRESS, STATUE)), FORTRESS, MILITARY, ECONOMY, MILITARY));
        this.allWonders.add(new Wonder("Forbidden City", ALLIED_CULTURES, GREAT_EMPIRES, new HashSet<>(Arrays.asList(PALACE, TEMPLE)), TEMPLE, ECONOMY, ECONOMY, ECONOMY));
